...
local CALIBER_VARIANTS = {
    ...
    Cal308Win = {
        ...
        variants = {
            { id = "Ammo.Cal308Win",      label = "FMJ",            short = "FMJ" },
            { id = "Ammo.Cal308Win_AP",   label = "Armor Pierce",   short = "AP" },
            { id = "Ammo.Cal308Win_HP",   label = "Hollow Point",   short = "HP" },
            { id = "Ammo.Cal308Win_EMP",  label = "EMP",            short = "EMP" },
            { id = "Ammo.Cal308Win_INC",  label = "Incendiary",     short = "INC" },
            { id = "Ammo.Cal308Win_CHEM", label = "Chemical",       short = "CHEM" },
            { id = "Ammo.Cal308Win_NL",   label = "Non-Lethal",     short = "NL" },
            { id = "Ammo.Cal308Win_HE",   label = "High Explosive", short = "HE" },
        },
    },
    Cal45Super = {
        label    = ".45 Super",
